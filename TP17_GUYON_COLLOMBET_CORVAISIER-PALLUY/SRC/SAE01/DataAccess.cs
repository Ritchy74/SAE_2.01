...
namespace SAE01
{
    ...
    class DataAccess
    {
        ...
        public Boolean openConnection()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Problème d'ouverture de connexion");
            }
        ...
        public void closeConnection()
        {
            ...
            {
                MessageBox.Show(ex.Message, "Close connection");
            }
        }
        ...
        public SqlDataReader getData(String getQuery)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Get data bug");
            }
        ...
        public Boolean setData(String setQuery)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Set data bug");
            }
